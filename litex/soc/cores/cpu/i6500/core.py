...
class i6500(CPU):
    ...
    def args_fill(parser):
        ...
        cpu_group.add_argument("--use-edif",              action="store_true",   help="Use EDIF netlist.")

    @staticmethod
    def args_read(args):
        i6500.use_edif = args.use_edif
    ...
    def __init__(self, platform, variant="standard"):
        ...
        if self.use_edif:
            self.platform.add_edif(os.path.join("xilinx_synth", "mips_soc.edif"))
            self.platform.add_source(os.path.join("xilinx_synth", "mips_soc.v"))
        else:
